> **⚠️ ARCHIVO HISTÓRICO.** Esta es la auditoría del **2026-07-27**, movida a `antiguo/` el 2026-07-29.
> La auditoría vigente vive un nivel arriba: [`docs/auditoria-prelanzamiento/README.md`](../README.md).
